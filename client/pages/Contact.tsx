  ...
  const faqs = [
    {
      ...
      answer:
        "Our fund minimums vary by fund vintage and structure, typically ranging from $5M to $25M for institutional investors. We also work with fund-of-funds and advisors who can aggregate smaller allocations. Please contact us to discuss options tailored to your investment profile.",
    },
    {
      question: "What is your typical investment holding period?",
      answer:
        "We target a 5-7 year hold period, though this varies based on market conditions and specific exit opportunities. Our approach is flexible—we exit when we've maximized value creation, not based on a fixed timeline.",
    },
    {
      question: "How do you handle portfolio company governance?",
      answer:
        "We maintain active board representation at all portfolio companies, typically with 1-2 board seats. Our team works closely with management to execute strategic initiatives, manage risk, and drive operational improvements throughout the hold period.",
    },
    {
      question: "What sectors do you focus on?",
      answer:
        "We invest across diversified sectors including Healthcare & Life Sciences, Business Services, Financial Services, Technology & Software, and Industrial & Manufacturing. We seek companies with $10M-$100M EBITDA and strong growth potential.",
    },
    {
      question: "How often do you provide investor reporting?",
      answer:
        "We provide comprehensive quarterly reporting including portfolio performance updates, detailed financial metrics, and company-specific developments. Annual meetings are held to discuss strategy and market outlook.",
    },
    {
      question: "Can you work with family offices and foundations?",
      answer:
        "Yes, we work extensively with family offices, endowments, and foundations. We can structure investments to meet specific governance, reporting, and liquidity requirements. Please contact our Investor Relations team to discuss customized solutions.",
    },
  ];
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-foreground/90">
              We're here to discuss investment opportunities, answer questions
              about our services, and explore how Anthony Crumbs & Sons can
              partner with you. Reach out using the form below or contact us
              directly.
            </p>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="portfolio-company">
                      Partnership Opportunity (Portfolio Company)
                    </option>
              ...
              <div className="bg-muted rounded-lg p-6 border border-border space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:inquiry@accrumbs.com"
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Whether you have questions about our services, investment
            opportunities, or would like to discuss a potential partnership, our
