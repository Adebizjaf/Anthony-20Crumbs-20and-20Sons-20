...
import { Calendar, User, ArrowRight, TrendingUp, Lightbulb, Newspaper } from "lucide-react";

type Category = "all" | "market-insights" | "thought-leadership" | "announcements";
...
export default function Insights() {
  ...
  const categories: { value: Category; label: string; icon: any }[] = [
    ...
    { value: "thought-leadership", label: "Thought Leadership", icon: Lightbulb },
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-primary-foreground/90">
              Stay informed with our latest market commentary, investment insights, thought leadership, and firm announcements. Explore the trends, strategies, and opportunities shaping private equity today.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-primary mb-8">Featured</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className={`bg-gradient-to-br ${featuredArticle.image} rounded-lg h-96 border border-accent/20`}></div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-primary mb-12">
            {activeCategory === "all" ? "Recent Articles" : categories.find(c => c.value === activeCategory)?.label}
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {filteredInsights.map((article) => (
              <article key={article.id} className="border border-border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-2xl mx-auto bg-white rounded-lg p-8 md:p-12 border border-border text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Subscribe to receive our latest insights, market commentary, and investment updates delivered to your inbox.
            </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="p-6 bg-muted rounded-lg border border-border hover:border-accent transition-colors cursor-pointer text-center">
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            If you'd like to discuss any of our insights or explore investment opportunities, we'd love to hear from you.
          </p>
          <a
            href="/contact"
